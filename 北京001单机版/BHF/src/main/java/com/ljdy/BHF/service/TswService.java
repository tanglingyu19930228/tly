...
/**
 * @ClassName TswService 
 * @Description (拦阻报警设施----铁丝网service) 
 * @Author 顾冲 guchong@luojiadeyi.com    
 * @Date 2017年9月26日 上午10:29:25 
 * @修改历史  
 *     1. [2017年9月26日]创建文件 by 顾冲
 */
public interface TswService {
   
	//poi导出列(备选库)
	public static final String[] columns = {"id", "xmlb","xmzl","xmmc","xmbh","bjfx","sslx","szsf","szcs","szq","jd", "wd", "dxlb","jsxz",
		"sydw","sbdw","zytz","dftz","tznd","jsdd","jsgm","lzmgs","tswlx","fj","bz"};
