...
/**
 * @ClassName ZsjtjpService 
 * @Description (交通保障设施----直升机停机坪service) 
 * @Author 顾冲 guchong@luojiadeyi.com    
 * @Date 2017年9月26日 上午11:47:49 
 * @修改历史  
 *     1. [2017年9月26日]创建文件 by 顾冲
 */
public interface ZsjtjpService {
   
	//poi导出列(备选库)
	public static final String[] columns = {"id", "xmlb","xmzl","xmmc","xmbh","bjfx","sslx","szsf","szcs","szq","jd", "wd", "dxlb","jsxz",
		"sydw","sbdw","zytz","dftz","tznd","jsdd","jsgm","tjplx","fj","bz"};
