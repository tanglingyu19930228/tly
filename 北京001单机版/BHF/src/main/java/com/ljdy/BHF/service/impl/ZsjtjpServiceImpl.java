...
/**
 * @ClassName ZsjtjpServiceImpl
 * @Description (交通保障设施----直升机停机坪service实现类)
 * @Author 顾冲 guchong@luojiadeyi.com
 * @Date 2017年9月26日 上午11:51:07
 * @修改历史 1. [2017年9月26日]创建文件 by 顾冲
 */
@Service("zsjtjpService")
public class ZsjtjpServiceImpl implements ZsjtjpService {
    @Resource
     ...
     * @param paramMap
     * @return
     * @see com.ljdy.BHF.service.ZsjtjpService#getJsgm(java.util.Map)
     * @Date 2017年9月28日
     * @修改历史 1. [2017年9月28日]创建文件 by 顾冲
     */
    @Override
    public List<Object> getJsgm(Map<String, Object> paramMap) {
        // 用户角色必传(2省级，1国家)，省级用户必传所在省份
        ...
        hql.append(") from Zsjtjp z where 1=1");
     ...
     * @param paramMap
     * @return
     * @see com.ljdy.BHF.service.ZsjtjpService#getTz(java.util.Map)
     * @Date 2017年9月28日
     * @修改历史 1. [2017年9月28日]创建文件 by 顾冲
     */
    @Override
    public List<Object> getTz(Map<String, Object> paramMap) {
        ...
        String roleName = (String) paramMap.get("roleName");
        List<Object> param = new ArrayList<Object>();
        StringBuffer hql = new StringBuffer("select new map(sum(z.zytz+z.dftz) as dxtz, sum(z.dftz) as dftz, sum(z.zytz) as zytz) from Zsjtjp z where 1=1");
        if(CommonUtil.validCondition(paramMap, "bxxm")){
            hql.append(" and z.bxxm = ?");
            param.add(paramMap.get("bxxm"));
        }
     ...
     */
    @Override
    public void addZsjtjp(Zsjtjp zsjtjp) {
        baseDao.save(zsjtjp);
    }
    ...
    /**
      * @Title updateData 
      * @Description (更新停机坪类型数据数据) 
      * @param zsjtjp 
      * @see com.ljdy.BHF.service.ZsjtjpService#updateData(com.ljdy.BHF.model.Zsjtjp)
      * @Date  2017年10月11日
      * @修改历史  
     ...
     */
    @Override
    public void updateData(Zsjtjp zsjtjp) {
        baseDao.update(zsjtjp);
    };
	...
	public List<Object> getData(Map<String, Object>condition){
        ...
        for (Object o : list) {
            ...
            result.add(BeanToMap.transMapToBean(map, Zsjtjp.class));
        }
        return result;
	}
	...
	public List<Object> getSumByJsxz(Map<String, Object> condition) {
		String hql="select sum(jsgm) from Zsjtjp z where 1=1 and z.jsxz = ? ";
	...
	public List<Object> getZytzSum() {
		String hql="select sum(zytz) from Zsjtjp";
	...
	public List<Object> getDftzSum() {
		String hql="select sum(dftz) from Zsjtjp";
		return baseDao.find(hql);
	...
	public List<Object> getManageData(Map<String, Object> condition) {
		List<Object>param = new ArrayList<Object>();
		String hql=" select new map(z.jszt as jszt ,sum(z.jsgm) as jsgm) from Zsjtjp z where 1=1 ";
	...
	public List<Object> getManageTz(Map<String, Object> condition) {
		String hql = "select new map(sum(z.zytz) as zytz , sum(z.dftz) as dftz, sum(z.dftz + z.zytz) as dxtz) from Zsjtjp z where 1=1 ";
		StringBuffer hqlStr = new StringBuffer(hql);
		List<Object>param = new ArrayList<Object>();
		if(CommonUtil.validCondition(condition, "szsf")){
			hqlStr.append(" and z.szsf like ? ");
	...
	public List<Object> getMaintenanceData(Map<String, Object> condition) {
		List<Object>param = new ArrayList<Object>();
		String hql=" select new map(z.syzt as syzt ,sum(z.jsgm) as jsgm) from Zsjtjp z where 1=1 ";
		StringBuffer hqlStr = new StringBuffer(hql);
		if(CommonUtil.validCondition(condition, "bxxm")){
			hqlStr.append(" and z.bxxm = ? ");
			param.add(condition.get("bxxm"));
	...
	@Override
	public void addZsjtjp(AddZsjtjp addZsjtjp) {
            baseDao.save(addZsjtjp);	
	}	
     ...
     * @param condition
     * @return
     * @see com.ljdy.BHF.service.ZsjtjpService#getDestroyData(java.util.Map)
     * @Date 2017年12月5日
     * @修改历史 1. [2017年12月5日]创建文件 by 顾冲
     */
    @Override
    public List<Object> getDestroyData(Map<String, Object> condition) {
        StringBuffer hql = new StringBuffer("select new map(z.id as id, z.xmmc as xmmc, z.xmbh as xmbh, z.jsgm as jsgm, z.syzt as syzt) from Zsjtjp z where 1=1");
        List<Object> param = new ArrayList<Object>();
