...
@Entity
@Table(name="JJMLFPT")
public class AddJjmlfpt implements java.io.Serializable{
	...
	public AddJjmlfpt(String xsltqk, String xsltwlxz, String xscsxl,
			String hxltqk, String hxltwlxz, String hxcsxl, String jb,
			String fzdd, String id) {
		super();
		this.xsltqk = xsltqk;
		this.xsltwlxz = xsltwlxz;
		this.xscsxl = xscsxl;
