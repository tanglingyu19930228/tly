...
<table class="tabList comBorder">
    <thead>
        <tr>
            ...
            <th>建设规模</th>
            <th class="thPosition">
                <span class="typeTitle" id="lwtlx"><i class="t_name">了望塔类型</i><i class="icons icons-down"></i>
	                <ul class="typeItem">
	                    <li><a>了望塔类型</a><i class="icons icons-up"></i></li>
...
<script>
	...
	function ajaxData(){
		...
		var lwtlxTag = false;//瞭望塔类型是否显示标识
		...
		var lwtlx = null;
		if($("#lwtlx").find(".t_name").text()!="了望塔类型"){
			if(lwtlxTag){
				lwtlx=$("#lwtlx").find(".t_name").text();
			}
		}
		var jszt = null;
		...
		var condition = {"szsf":'${szsf}',"xmlb":'${xmlb}',"xmzl":'${xmzl}',"sslx":sslx,"bjfx":bjfx,
			"dxlb":dxlb,"jsxz":jsxz,"tznd":tznd,"lwtlx":lwtlx,"offiset":$("#offiset").val(),"partTag":partTag,"jszt":jszt,"syzt":syzt};
		$.ajax({
