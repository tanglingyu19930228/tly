...
<table class="tabList comBorder">
    <thead>
        <tr>
            ...
            <th>传输方式</th>           
            <th class="thPosition">
                <span class="typeTitle" id="sblx"><i class="t_name">设备类型</i><i class="icons icons-down"></i>
                <ul class="typeItem">
                    <li><a>设备类型</a><i class="icons icons-up"></i></li>
...
<script>
	...
	function ajaxData(){
		...
		var sblx=null;
		if($("#sblx").find(".t_name").text()!="设备类型"){
			if(sblxTag){
				sblx=$("#sblx").find(".t_name").text();
			}
		}
		var jszt = null;
		...
		var condition = {"szsf":'${szsf}',"xmlb":'${xmlb}',"xmzl":'${xmzl}',"sslx":sslx,"bjfx":bjfx,
			"dxlb":dxlb,"jsxz":jsxz,"tznd":tznd,"sblx":sblx,"offiset":$("#offiset").val(),"partTag":partTag,"jszt":jszt,"syzt":syzt};
		$.ajax({
