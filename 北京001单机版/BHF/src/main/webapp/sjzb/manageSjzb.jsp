...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>  
  ...
  <thead>
  	<tr>
			...
			<th colspan="8">建设规模</th>
			<th rowspan="2">建设投资合计(万元)</th>
			<th rowspan="2">中央投资合计(万元)</th>
			<th rowspan="2">地方投资合计(万元)</th>
		</tr>
		<tr>
			<th style="width: 8%">待实施</th>
			<th style="width: 8%">已招投标</th>
			<th style="width: 8%">已开工</th>
			<th style="width: 8%">已初验</th>
			<th style="width: 8%">已竣工</th>
			<th style="width: 8%">已审计</th>
			<th style="width: 8%">建设数量合计</th>
	...
	<tbody style="text-align:right">
		...
		<tr>
			...
			<td class="td">执勤道路</td>
			<%-- <c:forEach items="${data.zqdl_data}" var="item" varStatus="i"> --%>
			<td>
				<c:forEach items="${data.zqdl_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
		...
		<tr>
			...
			<td class="td">执勤码头</td>
			<td><c:forEach items="${data.zqmt_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
			...
			<td><c:set var="count" value="0"></c:set>
		...
		<tr>
			...
			<td><c:forEach items="${data.zsjtjp_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
		...
		<tr>
			...
			<td class="td">铁丝网</td>
			<td><c:forEach items="${data.tsw_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
		...
		<tr>
			...
			<td class="td">铁栅栏</td>
			<td><c:forEach items="${data.tzl_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
		...
		<tr>
			...
			<td class="td">拒马</td>
			<td><c:forEach items="${data.juma_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
		...
		<tr>
			...
			<td class="td">拦阻桩</td>
			<td><c:forEach items="${data.lzz_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
		...
		<tr>
			<td class="td">隔离带</td>
			<td><c:forEach items="${data.gld_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
		...
		<tr>
			...
			<td class="td">报警线路</td>
			<td><c:forEach items="${data.bjxl_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
		...
		<tr>
			...
			<td><c:forEach items="${data.gj_jkzx_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
			...
			<td><c:set var="count" value="0"></c:set>
			<c:forEach items="${data.gj_jkzx_data}" var="item">
		    <c:set var="count" value="${count+item.jsgm }"></c:set>
			</c:forEach>
				<c:if test="${count ne 0 }">
					<fmt:formatNumber type="number" value="${count }" maxFractionDigits="4"/>
			...
			<td>个</td>
			<td>
				<c:if test="${not empty data.gj_jkzx_tz[0].dxtz }">
					<fmt:formatNumber type="number" value="${data.gj_jkzx_tz[0].dxtz }" maxFractionDigits="4"/>
				</c:if>
			</td>
			<td>
				<c:if test="${not empty data.gj_jkzx_tz[0].zytz }">
					<fmt:formatNumber type="number" value="${data.gj_jkzx_tz[0].zytz }" maxFractionDigits="4"/>
				</c:if>
			</td>
			<td>
				<c:if test="${not empty data.gj_jkzx_tz[0].dftz }">
					<fmt:formatNumber type="number" value="${data.gj_jkzx_tz[0].dftz }" maxFractionDigits="4"/>
				</c:if>
			</td>
		</tr>
		<tr>
			...
			<td><c:forEach items="${data.sj_jkzx_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
			...
			<td><c:set var="count" value="0"></c:set>
			<c:forEach items="${data.sj_jkzx_data}" var="item">
		    <c:set var="count" value="${count+item.jsgm }"></c:set>
			</c:forEach>
				<c:if test="${count ne 0 }">
					<fmt:formatNumber type="number" value="${count }" maxFractionDigits="4"/>
			...
			<td>个</td>
			<td>
				<c:if test="${not empty data.sj_jkzx_tz[0].dxtz }">
					<fmt:formatNumber type="number" value="${data.sj_jkzx_tz[0].dxtz }" maxFractionDigits="4"/>
				</c:if>
			</td>
			<td>
				<c:if test="${not empty data.sj_jkzx_tz[0].zytz }">
					<fmt:formatNumber type="number" value="${data.sj_jkzx_tz[0].zytz }" maxFractionDigits="4"/>
				</c:if>
			</td>
			<td>
				<c:if test="${not empty data.sj_jkzx_tz[0].dftz }">
					<fmt:formatNumber type="number" value="${data.sj_jkzx_tz[0].dftz }" maxFractionDigits="4"/>
				</c:if>
			</td>
		</tr>
		<tr>
			...
			<td><c:forEach items="${data.dj_jkzx_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
			...
			<td><c:set var="count" value="0"></c:set>
			<c:forEach items="${data.dj_jkzx_data}" var="item">
		    <c:set var="count" value="${count+item.jsgm }"></c:set>
			</c:forEach>
				<c:if test="${count ne 0 }">
					<fmt:formatNumber type="number" value="${count }" maxFractionDigits="4"/>
			...
			<td>个</td>
			<td>
				<c:if test="${not empty data.dj_jkzx_tz[0].dxtz }">
					<fmt:formatNumber type="number" value="${data.dj_jkzx_tz[0].dxtz }" maxFractionDigits="4"/>
				</c:if>
			</td>
			<td>
				<c:if test="${not empty data.dj_jkzx_tz[0].zytz }">
					<fmt:formatNumber type="number" value="${data.dj_jkzx_tz[0].zytz }" maxFractionDigits="4"/>
				</c:if>
			</td>
			<td>
				<c:if test="${not empty data.dj_jkzx_tz[0].dftz }">
					<fmt:formatNumber type="number" value="${data.dj_jkzx_tz[0].dftz }" maxFractionDigits="4"/>
				</c:if>
			</td>
		</tr>
		<tr>
			...
			<td><c:forEach items="${data.xj_jkzx_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
			...
			<td><c:set var="count" value="0"></c:set>
			<c:forEach items="${data.xj_jkzx_data}" var="item">
		    <c:set var="count" value="${count+item.jsgm }"></c:set>
			</c:forEach>
				<c:if test="${count ne 0 }">
					<fmt:formatNumber type="number" value="${count }" maxFractionDigits="4"/>
			...
			<td>个</td>
			<td>
				<c:if test="${not empty data.xj_jkzx_tz[0].dxtz }">
					<fmt:formatNumber type="number" value="${data.xj_jkzx_tz[0].dxtz }" maxFractionDigits="4"/>
				</c:if>
			</td>
			<td>
				<c:if test="${not empty data.xj_jkzx_tz[0].zytz }">
					<fmt:formatNumber type="number" value="${data.xj_jkzx_tz[0].zytz }" maxFractionDigits="4"/>
				</c:if>
			</td>
			<td>
				<c:if test="${not empty data.xj_jkzx_tz[0].dftz }">
					<fmt:formatNumber type="number" value="${data.xj_jkzx_tz[0].dftz }" maxFractionDigits="4"/>
				</c:if>
			</td>
		</tr>
		<tr>
			...
			<td class="td">监控站</td>
			<td><c:forEach items="${data.jkz_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
		...
		<tr>
			...
			<td class="td">传输线路</td>
			<td><c:forEach items="${data.csxl_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
		...
		<tr>
			...
			<td class="td">供电系统</td>
			<td><c:forEach items="${data.gdxt_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
		...
		<tr>
			...
			<td><c:forEach items="${data.jjm_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
			...
			<td><c:set var="count" value="0"></c:set>
			<c:forEach items="${data.jjm_data}" var="item">
		    <c:set var="count" value="${count+item.jsgm }"></c:set>
			</c:forEach>
				<c:if test="${count ne 0 }">
					<fmt:formatNumber type="number" value="${count }" maxFractionDigits="4"/>
			...
			<td>套</td>
			<td>
				<c:if test="${not empty data.jjm_tz[0].dxtz }">
					<fmt:formatNumber type="number" value="${data.jjm_tz[0].dxtz }" maxFractionDigits="4"/>
				</c:if>
			</td>
			<td>
				<c:if test="${not empty data.jjm_tz[0].zytz }">
					<fmt:formatNumber type="number" value="${data.jjm_tz[0].zytz }" maxFractionDigits="4"/>
				</c:if>
			</td>
			<td>
				<c:if test="${not empty data.jjm_tz[0].dftz }">
					<fmt:formatNumber type="number" value="${data.jjm_tz[0].dftz }" maxFractionDigits="4"/>
				</c:if>
			</td>
		</tr>
		<tr>
			...
			<td><c:forEach items="${data.wrzs_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
			...
			<td><c:set var="count" value="0"></c:set>
			<c:forEach items="${data.wrzs_data}" var="item">
		    <c:set var="count" value="${count+item.jsgm }"></c:set>
			</c:forEach>
				<c:if test="${count ne 0 }">
					<fmt:formatNumber type="number" value="${count }" maxFractionDigits="4"/>
			...
			<td>套</td>
			<td>
				<c:if test="${not empty data.wrzs_tz[0].dxtz }">
					<fmt:formatNumber type="number" value="${data.wrzs_tz[0].dxtz }" maxFractionDigits="4"/>
				</c:if>
			</td>
			<td>
				<c:if test="${not empty data.wrzs_tz[0].zytz }">
					<fmt:formatNumber type="number" value="${data.wrzs_tz[0].zytz }" maxFractionDigits="4"/>
				</c:if>
			</td>
			<td>
				<c:if test="${not empty data.wrzs_tz[0].dftz }">
					<fmt:formatNumber type="number" value="${data.wrzs_tz[0].dftz }" maxFractionDigits="4"/>
				</c:if>
			</td>
		</tr>
		<tr>
			...
			<td class="td">视频前端</td>
			<td><c:forEach items="${data.spqd_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
		...
		<tr>
			...
			<td class="td">显控终端</td>
			<td><c:forEach items="${data.xkzd_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
		...
		<tr>
			<td class="td">报警装置</td>
			<td><c:forEach items="${data.bjzz_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
		...
		<tr>
			...
			<td class="td">执勤房</td>
			<td><c:forEach items="${data.zqf_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
		...
		<tr>
			...
			<td class="td">了望塔</td>
			<td><c:forEach items="${data.lwt_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
		...
		<tr>
			<td class="td">标志牌</td>
			<td><c:forEach items="${data.bzp_data}" var="item">
					<c:if test="${item.jszt=='待实施'}">
						<fmt:formatNumber type="number" value="${item.jsgm }" maxFractionDigits="4"/>
					</c:if>
				</c:forEach></td>
